    ...
    <div className="login-shell">
      <aside className="login-aside">
        ...
        <div className="login-aside-mid">
          ...
          <p>
            A secured, API-first system for managing the full claims lifecycle: onboarding
            policyholders, issuing policies, and processing claims against coverage.
          </p>
          <Link to="/" className="login-back-link">← Back to home</Link>
        </div>
        <div className="login-aside-foot">Lumiq Numiqers — Application Epic, Story 4</div>
      </aside>
